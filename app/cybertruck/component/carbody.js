...
export default function CarBody() {
  ...
  return (
    ...
    >
      <div
        className={`[@media(min-width:500px)]:h-[600vh] [@media(max-width:500px)]:h-[100vh] [@media(min-width:900px)]:w-[70%] [@media(min-width:500px)]:w-[50%] [@media(max-width:500px)]:w-[100%]`}
      >
