...
export default function Navigation() {
  ...
  return (
    <nav className="w-full z-60 [@media(min-width:500px)]:fixed">
      <div className="flex flex-col absolute top-0 z-60 w-full">
        <div className="flex justify-between h-[40px] items-center [@media(min-width:500px)]:bg-white">
          ...
          {!menuOpen && (
            <div className="block [@media(min-width:950px)]:hidden">
              {" "}
              <button
                className="rounded [@media(max-width:500px)]:text-white text-sm bg-black/5 p-[6px] cursor-pointer"
